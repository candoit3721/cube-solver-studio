      ...
      <NavLink to="/" className="nav-logo" end>
        <span className="nav-logo-icon">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="88 58 340 358" width="26" height="26">
            ...
            <polygon points="102,168 145,193 145,237 102,212"  fill="#FFFFFF" stroke="#1a1a2e" strokeWidth="4" strokeLinejoin="round"/>
            <polygon points="155,198 198,223 198,267 155,242"  fill="#FF1F1F" stroke="#1a1a2e" strokeWidth="4" strokeLinejoin="round"/>
            ...
            <polygon points="155,251 198,276 198,320 155,295"  fill="#00C830" stroke="#1a1a2e" strokeWidth="4" strokeLinejoin="round"/>
            <polygon points="208,281 251,306 251,350 208,325"  fill="#00C830" stroke="#1a1a2e" strokeWidth="4" strokeLinejoin="round"/>
            <polygon points="102,274 145,299 145,343 102,318"  fill="#FFFFFF" stroke="#1a1a2e" strokeWidth="4" strokeLinejoin="round"/>
