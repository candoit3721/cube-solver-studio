...
export const CHAPTER_STATES = [
  ...
  // 4 — Yellow Cross
  // F2L done; D face has yellow cross (idx 1,3,4,5,7); edges aligned to centers;
  // corners scrambled — yellow sticker on side face at each corner (not on D face).
  // Corner orientations: FLD→yellow on F, FRD→yellow on R, BRD→yellow on B, BLD→yellow on L.
